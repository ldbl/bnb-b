...
def test_config():
    ...
    return {
        "data": {"symbol": "BNB/USDT", "lookback_days": 500, "timeframes": ["1d", "1w"]},
        "signals": {
        ...
        "fibonacci": {"lookback_days": 90, "min_swing_strength": 0.02, "proximity_threshold": 0.01},
        "weekly_tails": {
            "min_tail_ratio": 0.3,
