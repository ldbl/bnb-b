...
class WhaleTracker:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if volumes:
                    ...
                    whale_activity["high_volume_periods"].sort(
    ...
    def multi_period_whale_analysis(self):
        ...
        periods = [(1, "24 hours"), (3, "3 days"), (7, "1 week")]
        ...
        for days, period_name in periods:
            ...
            try:
                ...
                if whale_summary and whale_summary.get("high_volume_periods"):
                    ...
                    large_signals = len(
                        [p for p in high_vol_periods if "🦈 LARGE" in p["whale_signal"]]
                    )
                    ...
                    results[period_name] = {
                        ...
                        "buy_ratio": buy_ratio,
                        "top_signal": (
                            max(high_vol_periods, key=lambda x: x["volume_ratio"])
                            if high_vol_periods
                            else None
                        ),
                    }
    ...
    def display_whale_analysis(self, days_back: int = 1):
        ...
        if whale_summary:
            print(
                f"✅ Analyzed {whale_summary['total_candles']} {whale_summary['interval']} candles"
            )
