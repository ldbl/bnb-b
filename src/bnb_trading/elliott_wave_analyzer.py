...
class ElliottWaveAnalyzer:
    ...
    def analyze_elliott_wave(
        ...
        try:
            ...
            combined_analysis = self._combine_analyses(
                daily_analysis, weekly_analysis, daily_df, weekly_df
            )
    ...
    def _combine_analyses(
        ...
        try:
            ...
            return {
                ...
                "elliott_rules_valid": (
                    daily_analysis.get("validation", {}).get("valid", False)
                    and weekly_analysis.get("validation", {}).get("valid", False)
                ),
            }
    ...
    def _generate_trading_signals(
        ...
        if "WAVE_2" in daily_wave and daily_trend == "UPTREND":
            ...
            if (
                trend_momentum["momentum"] == "STRONG_BULL"
                and trend_momentum["strength"] > self.momentum_threshold
            ):
                signals.update(
                    {
                        "action": "HOLD_LONG",
    ...
    def _analyze_trend_momentum(
        ...
        try:
            ...
            if (
                market_regime in ["STRONG_BULL", "MODERATE_BULL"]
                and regime_confidence > self.momentum_threshold
            ):
