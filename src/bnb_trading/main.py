            ...
            if "elliott_wave_analysis" in signal:
                ...
                if "error" not in elliott_analysis:
                    ...
                    if elliott_analysis.get("elliott_rules_valid"):
                        print("   ✅ ELLIOTT WAVE ПРАВИЛА: Валидни")
                    else:
                        print("   ⚠️  ELLIOTT WAVE ПРАВИЛА: Нарушени")
